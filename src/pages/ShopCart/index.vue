      ...
      <div class="cart-body">
        ...
        >
          ...
          <li class="cart-list-con7">
            <a class="sindelet" @click="deleteCarById(cart)">删除</a>
            <br />
            <a href="#none">移到收藏</a>
          </li>
        </ul>
...
export default {
  ...
  computed: {
    ...
    isAllCheck() {
      // 遍历数组里面原理，只要全部元素isChecken属性都为1===>真 true
      // 只要有一个不是1=====>假 false
