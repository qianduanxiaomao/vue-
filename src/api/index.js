...
// URL：/api/user/passport/auth/getUserInfo   methode:get
export const reqUserInfo = () => requests({ url: '/user/passport/auth/getUserInfo', method: 'get' })

// 退出登录
// URL：/api/user/passport/logout    methode:get
export const reqLogout = () => requests({ url: '/user/passport/logout', method: 'get' })

// 获取用户地址信息
// URL:/api/user/userAddress/auth/findUserAddressList    methode:get
